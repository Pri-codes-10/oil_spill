...
# Make `app` importable when this file is run directly, so neither PYTHONPATH
# nor an editable install is required. B2 runs this at standup every day; a
# setup step that has to be remembered is a setup step that gets skipped.
